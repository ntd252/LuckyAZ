...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(132, 162);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(112, 33);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Lucky AZ";
			...
			this->pictureBox1->Location = System::Drawing::Point(123, 12);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Calibri", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(163)));
			this->label2->Location = System::Drawing::Point(94, 195);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(195, 23);
			this->label2->TabIndex = 2;
			this->label2->Text = L"Version 1.0 (build 1812)";
			// 
			// label3
			// 
			this->label3->AutoSize = true;
			this->label3->Font = (gcnew System::Drawing::Font(L"Calibri", 12, System::Drawing::FontStyle::Italic, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(163)));
			this->label3->Location = System::Drawing::Point(114, 232);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(153, 19);
			this->label3->TabIndex = 3;
			this->label3->Text = L"Developed by NTD252";
			// 
			// button1
			// 
			this->button1->Location = System::Drawing::Point(153, 327);
